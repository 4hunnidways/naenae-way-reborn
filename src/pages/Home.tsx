...
import founderPortrait from "@/assets/founder-meet.jpeg";
...
export default function Home() {
  useSeo(
    "Nae Nae's Way — Strength in Action",
    "A nonprofit founded by Shonee Jackson that bridges gaps and shines a light on community, health and wellbeing initiatives.",
  );
  return (
    <Layout>
        ...
        <div className="container-narrow grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground text-lg max-w-prose">
              Nae Nae's Way knows that strength lies not only in the words we say, but in
              the actions we take. Explore the causes we champion every day.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              {initiatives.map((i) => (
                <Link key={i.slug} to={`/initiatives/${i.slug}`} className="pill-link text-sm">
                  {i.label}
                </Link>
              ))}
            </div>
      ...
      <section className="section bg-surface">
        <div className="container-narrow text-center">
          ...
          <p className="mt-6 text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            My life took a traumatic twist back in 1993. Although the struggles that followed
            were real, the strength I gained from that experience made me the woman I am today.
            Out of my struggles, Nae Nae's Way was born. I'm determined to join forces with
            progressive agencies and individuals, becoming a portal to bridge the gap and shine
            a light on those needing assistance. I have taken control and am doing things, Nae
            Nae's Way.
          </p>
          <a href="mailto:naenaesway@outlook.com" className="pill-link mt-8 inline-flex">
        ...
        <div className="container-narrow grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Shonee Jackson is the founder of the non-profit organization 4Hunnid Ways and CEO
                of Nae Nae's Way Inc. A social activist who believes in enriching the lives of
                children, she has advocated for youth as a tutor, mentor, and community leader.
              </p>
              <p>
                With experience in strategic development from launching her son Keenon's (YG)
                music career, Shonee founded 4Hunnid Ways — a 501(c)(3) whose mission is to
                enhance the lives of disadvantaged youth in the foster care system through STEM
                education.
              </p>
              <p>
                Driven and committed, Shonee continues to give youth and adults a deeper sense of
                pride — letting them know that someone cares, and showing them positive change is
                possible.
              </p>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container-narrow rounded-3xl p-10 md:p-16 text-center" style={{ background: "var(--gradient-pink)" }}>
          ...
          <p className="mt-4 text-primary-foreground/90 max-w-xl mx-auto">
            Every contribution helps us bridge the gap for families, youth, and communities who
            need a hand and a voice.
          </p>
